const workspaceLinks = [
  ...
  {
    href: "/bots/customizer",
    title: "Widget customizer",
    description: "Tune chat colors, typography, and greeting copy with an immediate preview.",
  },
  {
    ...
    <main className="min-h-screen bg-[#f6f8fb] text-slate-950">
      <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        <section className="border-b border-slate-200 pb-5">
          <p className="text-sm font-semibold leading-6 text-slate-500">AgentDesk workspace</p>
          <h1 className="mt-2 text-3xl font-semibold leading-tight tracking-normal">AI support operations</h1>
        ...
        <section className="grid gap-4 py-6 md:grid-cols-3">
          {workspaceLinks.map((link) => (
            <a
              ...
              key={link.href}
            >
              <h2 className="text-lg font-semibold leading-tight text-slate-950">{link.title}</h2>
