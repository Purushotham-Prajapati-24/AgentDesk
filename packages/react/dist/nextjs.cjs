...
var import_react, import_core, listenerBuckets, globalListenerInstalled, globalListenerRef, SCRIPT_TAG;
var init_src = __esm({
  "src/index.tsx"() {
    "use strict";
    "use client";
    import_react = require("react");
    import_core = require("@agentdeskbot/core");
    listenerBuckets = /* @__PURE__ */ new Map();
    globalListenerInstalled = false;
    globalListenerRef = null;
    SCRIPT_TAG = "data-agentdesk";
  }
});
...
__export(nextjs_exports, {
  AgentDeskWidget: () => AgentDeskWidget2,
  default: () => nextjs_default
});
module.exports = __toCommonJS(nextjs_exports);
var import_dynamic = __toESM(require("next/dynamic"));
var AgentDeskWidget2 = (0, import_dynamic.default)(
